...
import {arrImgs} from '../adminPage/upLoadPhoto.js';
import {Admin} from '../adminPage/classAdmin.js';

// add event for valid [input firstName & lastname ]
const inpFirstName = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > input.inpFirstName');
const inpLastName = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > input.inpLastName');
...
const inpUserName = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > input.inpUserName');
...
const inpEmail = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > input.inpEmail');
inpEmail.addEventListener('keyup',function(){validInpEamil(this)});


// add event for show and hidd << value >>  [input password ]
const iconShowHiddPassWord = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > div > input.inpPassWord + a.iconShowHiddPassWord');
const inputsPassword = document.querySelectorAll('body #container #main > section.leftSection .account .infoAdmin > form :is(div > .inpPassWord, input.inpPasswordConfirm)');
...
const inpPassWord = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > div > input.inpPassWord');
...
const inpConfirmPassWord = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > input.inpPasswordConfirm');
inpConfirmPassWord.addEventListener('keyup',function(){validInpPasswordConfirm(inpPassWord,this)});

const inpsRadioGender = document.querySelectorAll('body #container #main > section.leftSection .account .infoAdmin > form  input[name="gender"]');  

// add event for valid  [input birthDay ]
const inpBirthDay = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form div input.inpBirthDay');
...
// add event for btn Save Info Admin 
const btnSaveInfoAdmin = document.querySelector('body #container #main > section.leftSection .account .infoAdmin > form > input.btnSaveInfoAdmin');
btnSaveInfoAdmin.onclick = function(){
    let inpGender = '';
    const obj = {};
    ...
    if(Object.keys(obj).length){
        Admin.editeInfoAdmin(obj,inpUserName,inpEmail);
    }
