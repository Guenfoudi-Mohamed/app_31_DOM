...
const lightMode = document.querySelector('body #container #main > section.rightSection .profileAdmin-mode-DL .mode-dark-light span.sun');
const darkMode = document.querySelector('body #container #main > section.rightSection .profileAdmin-mode-DL .mode-dark-light span.moon');
...
darkMode.addEventListener('click',function(){
    ...
    document.documentElement.style.setProperty('--boxSadowBoxs','0px 0px 10px 0px rgb(255, 255, 255, .3)');
